...
import { BscNetworkInfo, CeloNetworkInfo, PolygonNetworkInfo, SUPPORTED_NETWORK_VERSIONS } from 'constants/networks'
    ...
    <Container ref={node}>
      <Wrapper onClick={() => setShowMenu(!showMenu)}>
        <RowFixed>
          ...
          {[EthereumNetworkInfo, PolygonNetworkInfo, CeloNetworkInfo, BscNetworkInfo].includes(activeNetwork) ? null : (
